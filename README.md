...
21. ### What are controlled components?
    ...
    In React, a controlled component refers to a form element, like an input or textarea, whose value is controlled by React state. Instead of letting the DOM (Document Object Model) handle the form data, React manages it through its component state.
...
23. ### What are uncontrolled components?
    ...
    An uncontrolled component in React is the opposite of a controlled component. Instead of having React manage the form element's state, it allows the DOM to handle it directly.
